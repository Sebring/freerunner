import { Entity, FComponent, FGame } from "../../../freerunner.js";
...
interface Collision extends C_Collision, FComponent {}

const DEG_TO_RAD = Math.PI / 180

export function CollisionClosure(F:FGame) {
...
export default CollisionClosure
