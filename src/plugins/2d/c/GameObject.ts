import { Component, Entity, FComponent } from "../../../freerunner";
import { Point } from "../2d";
import { AABB, cloneAABB, createAABB } from "../lib/Aabb";
import { createPoint } from "../lib/Point";
import { createPolygonfromRect, Polygon, polygonToAABB, rotatePolygon } from "../lib/Polygon";
import { getRect, Rect } from "../lib/Rect";
import { Rotatable } from "../lib/Rotatable";
import { HashMapSystem } from "../s/HashMap";
import { RectSystem } from "../s/RectPool";
...
interface Named2dComp extends C_2D, Component {}

const GameObject: FComponent = {
